...
public class SpreadsheetCellStyleTest {
    ...
    public void aNewSpreadsheetCellStyle_HasAllNullProperties() {
        ...
        assertThat(cellStyle.getHorizontalAlign(), nullValue());
    ...
    public void SpreadsheetCellStyle_IsImmutable() {
        ...
        assertThat(cellStyle.withHorizontalAlign(HorizontalAlignment.CENTER), is(not(cellStyle)));
    ...
    public void apply_TransfersAllPropertiesToCopy() {
        SpreadsheetCellStyle src = new SpreadsheetCellStyle()
                ...
                .withStrikeout(true)
                .withUnderline(true)
                .withHorizontalAlign(HorizontalAlignment.CENTER)
        ...
        assertThat(applied.getHorizontalAlign(), is(HorizontalAlignment.CENTER));
    ...
    public void equals_IsTrueWhenDifferentFontsHaveTheSameProperties() {
        SpreadsheetCellStyle one = new SpreadsheetCellStyle().withBold(true).withFontName("Courier")
                .withWrapText(true).withDataFormatString("0.00").withHorizontalAlign(HorizontalAlignment.CENTER);
    ...
    public void equals_IsFalseIfAnyPropertyIsDifferent() {
        SpreadsheetCellStyle one = new SpreadsheetCellStyle().withBold(true).withFontName("Courier")
                .withWrapText(true).withDataFormatString("0.00").withHorizontalAlign(HorizontalAlignment.CENTER);
        SpreadsheetCellStyle two = new SpreadsheetCellStyle().withBold(true).withFontName("Courier")
                .withWrapText(true).withDataFormatString("#,##0").withHorizontalAlign(HorizontalAlignment.CENTER);
    ...
    public void CellStyleFont_IsCreatedWhenAFontPropertyIsSet() {
        ...
        cellStyle = cellStyle.withHorizontalAlign(HorizontalAlignment.CENTER);    // setting a cell property (rather than a font property)
